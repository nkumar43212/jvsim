...
#ifndef PROTOBUF_npu_5futilization_2eproto__INCLUDED
#define PROTOBUF_npu_5futilization_2eproto__INCLUDED
...
class NetworkProcessorUtilization : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_npu_5futilization_2eproto();
  friend void protobuf_AssignDesc_npu_5futilization_2eproto();
  friend void protobuf_ShutdownFile_npu_5futilization_2eproto();
...
class PacketLoad : public ::google::protobuf::Message {
 public:
  ...
  ::google::protobuf::uint64 rate() const;
  void set_rate(::google::protobuf::uint64 value);
...
static const int kJnprNpuUtilizationExtFieldNumber = 12;
...
inline ::google::protobuf::uint64 PacketLoad::rate() const {
  // @@protoc_insertion_point(field_get:PacketLoad.rate)
  return rate_;
}
inline void PacketLoad::set_rate(::google::protobuf::uint64 value) {
  set_has_rate();
  rate_ = value;
...
#endif  // PROTOBUF_npu_5futilization_2eproto__INCLUDED
