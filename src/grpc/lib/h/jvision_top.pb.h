...
#ifndef PROTOBUF_jvision_5ftop_2eproto__INCLUDED
#define PROTOBUF_jvision_5ftop_2eproto__INCLUDED
...
class TelemetryFieldOptions : public ::google::protobuf::Message {
 ...
 private:
  ...
  bool is_counter_;
  bool is_gauge_;
  friend void  protobuf_AddDesc_jvision_5ftop_2eproto();
  friend void protobuf_AssignDesc_jvision_5ftop_2eproto();
  friend void protobuf_ShutdownFile_jvision_5ftop_2eproto();
...
class EnterpriseSensors : public ::google::protobuf::Message {
 public:
  ...
  bool has_junipernetworks() const;
  void clear_junipernetworks();
  static const int kJuniperNetworksFieldNumber = 2636;
  const ::JuniperNetworksSensors& junipernetworks() const;
  ::JuniperNetworksSensors* mutable_junipernetworks();
  ::JuniperNetworksSensors* release_junipernetworks();
  void set_allocated_junipernetworks(::JuniperNetworksSensors* junipernetworks);

  GOOGLE_PROTOBUF_EXTENSION_ACCESSORS(EnterpriseSensors)
  // @@protoc_insertion_point(class_scope:EnterpriseSensors)
 private:
  inline void set_has_junipernetworks();
  inline void clear_has_junipernetworks();
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::JuniperNetworksSensors* junipernetworks_;
  friend void  protobuf_AddDesc_jvision_5ftop_2eproto();
  friend void protobuf_AssignDesc_jvision_5ftop_2eproto();
  friend void protobuf_ShutdownFile_jvision_5ftop_2eproto();
...
// optional .JuniperNetworksSensors juniperNetworks = 2636;
inline bool EnterpriseSensors::has_junipernetworks() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void EnterpriseSensors::set_has_junipernetworks() {
  _has_bits_[0] |= 0x00000001u;
}
inline void EnterpriseSensors::clear_has_junipernetworks() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void EnterpriseSensors::clear_junipernetworks() {
  if (junipernetworks_ != NULL) junipernetworks_->::JuniperNetworksSensors::Clear();
  clear_has_junipernetworks();
}
inline const ::JuniperNetworksSensors& EnterpriseSensors::junipernetworks() const {
...
inline ::JuniperNetworksSensors* EnterpriseSensors::mutable_junipernetworks() {
...
inline ::JuniperNetworksSensors* EnterpriseSensors::release_junipernetworks() {
  clear_has_junipernetworks();
  ::JuniperNetworksSensors* temp = junipernetworks_;
  junipernetworks_ = NULL;
  return temp;
}
inline void EnterpriseSensors::set_allocated_junipernetworks(::JuniperNetworksSensors* junipernetworks) {
...
#endif  // PROTOBUF_jvision_5ftop_2eproto__INCLUDED
