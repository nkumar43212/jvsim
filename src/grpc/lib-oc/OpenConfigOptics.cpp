...
OpenConfigOptics::iterate (JuniperNetworksSensors *handle, telemetry::OpenConfigData *datap)
{
    ...
    for (int i = 0; i < message->optics_diag_size(); i++) {
        ...
        if (diags.has_laser_output_power_low_alarm_threshold_dbm()) {
            kv = datap->add_kv();
        ...
        if (diags.has_laser_output_power_high_warning_threshold_dbm()) {
            kv = datap->add_kv();
        ...
        if (diags.has_laser_output_power_low_warning_threshold_dbm()) {
            kv = datap->add_kv();
        ...
        for (int j = 0; j < diags.optics_lane_diag_stats_size(); j++) {
            ...
            if (lanediags.has_lane_laser_output_power_low_alarm()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_output_power_high_warning()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_output_power_low_warning()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_receiver_power_high_alarm()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_receiver_power_low_alarm()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_receiver_power_high_warning()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_receiver_power_low_warning()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_bias_current_high_alarm()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_bias_current_low_alarm()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_bias_current_high_warning()) {
                kv = datap->add_kv();
            ...
            if (lanediags.has_lane_laser_bias_current_low_warning()) {
                kv = datap->add_kv();
