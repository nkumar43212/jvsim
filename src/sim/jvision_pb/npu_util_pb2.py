...
DESCRIPTOR.extensions_by_name['jnpr_npu_util_ext'] = jnpr_npu_util_ext
...
jnpr_npu_util_ext.message_type = _NETWORKPROCESSORUTILIZATION
jvision__top__pb2.JuniperNetworksSensors.RegisterExtension(jnpr_npu_util_ext)
