...
def jv_encode_iptunnels(jnpr, index, lc_slot, system_params):
    ...
    record.rx_packets            = random.randint(1, 7000000);
    record.rx_bytes              = random.randint(1, 7000000);
    record.tx_packets            = random.randint(1, 7000000);
    record.tx_bytes              = random.randint(1, 7000000);
